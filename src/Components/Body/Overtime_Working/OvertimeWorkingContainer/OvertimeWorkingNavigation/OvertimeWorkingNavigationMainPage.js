                ...
                <div className="PersonalNavigation_WorkStatus">
                    ...
                    {ClicksOnOff ? (
                        <ul className="PersonalNavigation_WorkStatus_ListsShow">
                            ...
                            <li
                                id={currentPageOn === 'OvertimeHistory' ? 'PersonalNavigation_WorkStatus_CurrentPage' : ''}
                                onClick={() => handleClickMenu('OvertimeHistory')}
                            >
                                <span className="PersonalNavigation_WorkStatus_ListsShow_Icons">
                ...
                <div className="PersonalNavigation_WorkStatus">
                    ...
                    {TeamClicksOnOff ? (
                        <ul className="PersonalNavigation_WorkStatus_ListsShow">
                            ...
                            <li
                                id={currentPageOn === 'Team_OvertimeHistory' ? 'PersonalNavigation_WorkStatus_CurrentPage' : ''}
                                onClick={() => handleClickMenu('Team_OvertimeHistory')}
                            >
                                <span className="PersonalNavigation_WorkStatus_ListsShow_Icons">
                                    <FaCalendarAlt></FaCalendarAlt>
                                </span>
                                <span>팀원 연장근무 내역 조회</span>
                            </li>
                        </ul>
                    ) : (
                        <div></div>
